                ...
                <article class="emblem-card">
                    ...
                    <div class="emblem-stage">
                        <img
                            ...
                            src="./assets/emblems/types/${escapeAttribute(item.id)}.png"
                            alt="${escapeAttribute(item.name)}"
                        >

                        <img
                            class="emblem-frame-art"
                            src="./assets/emblems/frames/${escapeAttribute(item.attribute)}_${selectedRank}.png"
                            alt=""
                            aria-hidden="true"
                        >

                        ${
                            Array.isArray(item.stoneRanks) &&
                            item.stoneRanks.includes(selectedRank)
                                ? `
                                    <img
                                        class="emblem-stone-art"
                                        src="./assets/emblems/stones/stone_${escapeAttribute(item.attribute)}.png"
                                        alt=""
                                        aria-hidden="true"
